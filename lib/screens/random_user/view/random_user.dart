...
import 'package:random_user/screens/random_user/modal/random_user_modal.dart';
import 'package:sizer/sizer.dart';

import '../../utility/apis/api_call.dart';
import '../controller/random_user_controller.dart';
            ...
            builder: (context, snapshot) {
              if (snapshot.hasError) {
                ...
                l1 = (randomUserController.user!.isEmpty
                    ? l1
                    : randomUserController.user) as List<Results>?;
                // randomUserController.ref(snapshot.data);
